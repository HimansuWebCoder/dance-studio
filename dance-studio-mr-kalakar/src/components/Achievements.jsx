  ...
  return (
    <div className="max-w-7xl mx-auto m-0 ">
      <div className="grid grid-cols-2 gap-2 p-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <div className="rounded-none h-[200px] md:h-[200px] md:h-[280px]  flex justify-center bg-gradient-to-r from-blue-600 via-purple-400 via-green-400 via-red-400 to-blue-600 p-0 rounded-xl items-center shadow-lg hover:shadow-2xl transition">
        ...
        <div className="rounded-none h-[200px] md:h-[280px] rounded-xl flex justify-center items-center bg-gradient-to-tr from-red-100 via-pink-50 to-red-50 shadow-lg hover:shadow-2xl transition">
          <div className="w-full h-full rounded-xl bg-gradient-to-r from-blue-600 via-purple-400 via-green-400 via-red-400 to-blue-600 p-0 rounded-xl flex justify-center items-center overflow-hidden">
            <img
        ...
        {/*<div className="grid grid-rows-2 gap-2 ">*/}
          <div className="h-[200px] md:h-[280px] rounded-xl overflow-hidden bg-gradient-to-r from-blue-600 via-purple-400 via-green-400 via-red-400 to-blue-600 p-0">
        ...
        <div className="rounded-none h-[200px] md:h-[280px] flex justify-center items-center bg-gradient-to-bl from-indigo-100 via-purple-50 to-blue-50 shadow-lg hover:shadow-2xl transition">
          <div className="w-full h-full rounded-xl bg-gradient-to-r from-blue-600 via-purple-400 via-green-400 via-red-400 to-blue-600 p-0 flex justify-center items-center overflow-hidden">
            <img
